...
function Zombie(startx, starty, startNumCycles){
	...
	this.intelligence = 100; //A ratio of how much the zombie follows the player, >1 required
}
...
Zombie.prototype.move = function(playerX, playerY){
	...
	if (z.numCycles==0){   // only move every once in a while
  		...
  		if(randChase==0) z.rot = Math.round(Math.atan2(playerY-z.y, playerX-z.x)*10)/10.0;
